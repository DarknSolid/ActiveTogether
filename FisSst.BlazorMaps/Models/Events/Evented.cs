...
namespace FisSst.BlazorMaps
{
    ...
    public abstract class Evented : JsReferenceBase
    {
        ...
        private const string MoveJsFunction = "move";
        ...
        public async Task Move(Func<MouseEvent, Task> callback)
        {
            await On(MoveJsFunction, callback);
        }

        public async Task MoveEnd(Func<MouseEvent, Task> callback)
        {
